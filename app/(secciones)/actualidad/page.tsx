...
const articles = [
    {
      ...
      tags: ['transparencia', 'restauración', 'análisis', 'moda', 'necesidad']
    },
    {
      ...
      tags: ['innovación', 'gastronomía', 'tendencias', 'alimentos', 'bebidas']
    },
    {
      ...
      tags: ['regulatorios', 'industria alimentaria', 'desafíos', 'directores', 'alimentos']
    },
    {
      ...
      tags: ['sostenibilidad', 'cadena de suministro', 'AIDABE', 'prácticas sostenibles', 'industria alimentaria']
    },
    {
      ...
      tags: ['experiencia del cliente', 'restauración', 'éxito', 'directores', 'alimentos y bebidas']
    },
  ];
